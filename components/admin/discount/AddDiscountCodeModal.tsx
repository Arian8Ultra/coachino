...
import AdminAddModal from "@/components/admin/General/AdminAddModal";
...
export default function AddDiscountCodeModal() {
	return (
		<AdminAddModal<DiscountCodeForm>
			typeName='discountcode'
			title='کد تخفیف'
			triggerText='افزودن کد تخفیف'
