  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant='accent' className="w-fit">افزودن اشتراک</Button>
      </DialogTrigger>
      <DialogContent className='sm:max-w-[425px] max-h-[80vh] overflow-y-auto rtl'>
        <DialogHeader className='sticky top-0 bg-glass backdrop-blur-md p-3 rounded-lg border'>
          <DialogTitle className="text-center">افزودن اشتراک جدید</DialogTitle>
        </DialogHeader>
        <form className='grid gap-4 py-4' onSubmit={handleSubmit}>
          ...
          <div className='mt-4 flex justify-end'>
            <Button type='submit'>افزودن اشتراک</Button>
          </div>
        </form>
      </DialogContent>
    </Dialog>
