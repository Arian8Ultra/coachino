  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <GlassBall className='bg-[#FB6D9D]/10 h-fit w-fit sticky top-0 left-0 translate-x-1/2 -translate-y-1/2 -mb-5'>
            <Presentation className='text-accent-foreground' />
          </GlassBall>
          {/* <Presentation className='mb-8' /> */}
          <p className='my-2'>تعداد کوچینگ</p>
          <p className='font-bold text-center'>+۱۸۹۰ نفر</p>
        </div>
        ...
        text-accent-foreground relative'
        >
          <GlassBall className='bg-[#9F8BFA]/10 h-fit w-fit sticky top-0 left-0 translate-x-1/2 -translate-y-1/2 -mb-5'>
            <Smile className='text-accent-foreground' />
          </GlassBall>
          <p className='my-2'>رضایت کاربران</p>
          <p className='font-bold text-center'>۹۶٪ رضایت</p>
        </div>
        ...
        text-accent-foreground relative'
        >
          <GlassBall className='bg-[#5CD1F2]/10 h-fit w-fit sticky top-0 left-0 translate-x-1/2 -translate-y-1/2 -mb-5'>
            <Briefcase className='text-accent-foreground' />
          </GlassBall>
          <p className='my-2'>مشتریان سازمانی</p>
          <p className='font-bold text-center'>۱۳ نفر</p>
        </div>
        <div
          className='p-4 rounded-lg h-full  w-full bg-[#FFB868] shadow-2xl shadow-[#FFB868]
        text-accent-foreground relative'
        >
          <GlassBall className='bg-[#FFB868]/10 h-fit w-fit sticky top-0 left-0 translate-x-1/2 -translate-y-1/2 -mb-5'>
            <Briefcase className='text-accent-foreground' />
          </GlassBall>
          <p className='my-2'>کاربران فعال</p>
          <p className='font-bold text-center'>+۲۷۰ نفر</p>
        </div>
      </motion.div>
    </motion.div>
  );
